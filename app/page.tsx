  ...
  return (
    <div className="w-full h-screen flex justify-center items-center">
      <div className='w-full h-full flex justify-around flex-col  items-center '>
        ...
        <p className=' startText font-bold text-2xl text-white text-center'>Social Dash is a Social site that does it all want to post or tweet or even upload videos here you can do everything</p>

        <div className=' content2 lex items-center justify-center w-full'>
            < h2>Please Create account or Login if you have one</ h2>
            < h2>Please Create account or Login if you have one</ h2>
        </div>
        <div className=' startBtnFlipIn w-full h-40 flex items-center justify-around'>
