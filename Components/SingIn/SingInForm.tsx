  ...
  return (
    <form className='SingInForm flex justify-center items-center flex-col '>
        ...
        <div className='w-2/3 h-32 my-9 flex justify-around items-center flex-col' >
            ...
            <input onChange={(e)=>{setUEmail(e.target.value)}} className=' text-white font-medium w-64 h-9 rounded-md bg-blue-300 ' type="text" ></input>
        </div>

        
        <div className='w-2/3 h-32 my-9 flex justify-around items-center flex-col' >
            <label  className='text-2xl font-semibold'>User name</label>
            <input onChange={(e)=>{setUserName(e.target.value)}} className='  text-white font-medium w-64 h-9 rounded-md bg-blue-300 ' type="text" ></input>
        </div>

        
        <div className='w-2/3 h-32 my-9 flex justify-around items-center flex-col' >
            <label  className='text-2xl font-semibold'>Where do you live</label>
            <select onChange={(e)=>{setPlaceToLive(e.target.value)}} className=' text-white font-medium font w-64 h-9 rounded-md bg-blue-300 '  >
        ...
        <div className='w-2/3 h-32 my-9 flex justify-around items-center flex-col' >
            ...
            <input onChange={(e)=>{setPassword(e.target.value)}} className=' text-white font-medium w-64 h-9 rounded-md bg-blue-300 ' type="password" ></input>
        </div>


        <div className='w-2/3 h-32 my-9 flex justify-around items-center flex-col' >
            <label  className='text-2xl font-semibold'>Choose an Profile Img</label>
            <input onChange={(e)=>{if(e.target.files)
              setProfileImg(e.target.files[0])}
              } className='custom-file-input' type="file" ></input>
        </div>
