...
function TweetCreateComment({comments,setComments,totalComments,setTotalComments,user,tweetId}:props) {
  ...
  return (
    <div>
        <input maxLength={252}  value={text} onChange={(e)=>{setText(e.target.value)}} className='focus:outline-1 focus:outline-white  duration-200 text-center  h-6  w-44 2xl:w-60 bg-transparent mx-5 shadow-md text-white font-medium text-xs ' ></input>
