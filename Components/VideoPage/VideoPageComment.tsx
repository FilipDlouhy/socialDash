  ...
  return (
    <div className='flex w-5/6 h-24 ChatDeleteBtn my-3 mx-auto'>
        <div className='w-2/5 h-full flex flex-col justify-around items-center'>
           {comment.userImg && <img src={comment.userImg} className='md:w-14 w-8 h-8 md:h-14 rounded-full'></img>}
            <p className='text-xs text-center font-semibold text-white' >{comment.userName}</p>
        </div>
