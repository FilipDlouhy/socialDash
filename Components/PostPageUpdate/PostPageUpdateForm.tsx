...
interface props{
    ...
    setImgNew:React.Dispatch<React.SetStateAction<any>>
    setImgOld:React.Dispatch<React.SetStateAction<any>>
    Title:string
    Category:string
}
...
function PostPageUpdateForm({Category,Title,setTitle ,setCategory ,setImgOld,setImgNew}:props) {
  return (
    ...
    <div className='w-full h-24 flex items-center justify-around flex-col '>
            ...
            <input value={Title} onChange={(e)=>{setTitle(e.target.value)}} maxLength={25}  className=' text-black font-medium w-64 h-9 rounded-md bg-white ' type="text" ></input>
            ...
            <div className='w-full h-24 flex items-center justify-around flex-col '>
                ...
                <label className='text-2xl font-semibold  text-white' >Post Img</label>
                <input  onChange={(e)=>{
                    if(e.target.files){
            ...
            <select  value={Category} onChange={(e)=>{setCategory(e.target.value)}} className=' font-medium w-64 h-9 rounded-md bg-white text-black ' id="country" name="country">
...
export default PostPageUpdateForm